"""Sloan donor deck: slide index mapping and placeholder targets."""
...
from .models import AGENDA_SLOAN_DONOR_TABLE, TemplateProfile
...
SLOAN_DEFAULT_DONOR = "templates/Sloan_Donor_Deck.pptx"

SLOAN_PROFILE = TemplateProfile(
    id="sloan",
    label="Sloan MIT donor deck",
    default_donor_relative=SLOAN_DEFAULT_DONOR,
    slide_type_map=SLIDE_TYPE_MAP,
    agenda_render_mode=AGENDA_SLOAN_DONOR_TABLE,
    is_implemented=True,
)
